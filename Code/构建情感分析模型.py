...
# 读入正面、负面情感评价词
pos_comment = pd.read_csv("../Data/正面评价词语（中文）.txt", header=None,
                          encoding='utf-8', engine='python')
neg_comment = pd.read_csv("../Data/负面评价词语（中文）.txt", header=None,
                          encoding='utf-8', engine='python')
pos_emotion = pd.read_csv("../Data/正面情感词语（中文）.txt", header=None,
                          encoding='utf-8', engine='python')
neg_emotion = pd.read_csv("../Data/负面情感词语（中文）.txt", header=None,
                          encoding='utf-8', engine='python')
...
# 使用pd.concat替代append，兼容pandas 2.0+
...
# 检查背景图片文件是否存在
bg_path = '../Data/pl.jpg'
backgroud_Image = plt.imread(bg_path) if os.path.exists(bg_path) else None
